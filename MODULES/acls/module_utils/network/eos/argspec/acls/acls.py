...
class AclsArgs(object):  # pylint: disable=R0903
    ...
    argument_spec = {'config': {'elements': 'dict',
            'options': {'acls': {'elements': 'dict',
                                 'options': {'aces': {'options': {'destination': {'mutually_exclusive': [['address',
                                                                                                          'subnetaddress',
                                                                                                          'any',
                                                                                                          'host'],
                                                                                                         ['wildcard_bits',
                                                                  ...
                                                                  'log': {'type': 'bool'},
                                                                  'protocol': {'type': 'str'},
                                                                  'protocol_options': {'options': {'icmp': {'options': {'administratively_prohibited': {'type': 'bool'},
                                                                                                            ...
                                                                                                            'type': 'dict'},
                                                                                                   'icmpv6': {'options': {'address_unreachable': {'type': 'bool'},
                                                                                                                          'beyond_scope': {'type': 'bool'},
                                                                                                                          'echo_reply': {'type': 'bool'},
                                                                                                                          'echo_request': {'type': 'bool'},
                                                                                                                          'erroneous_header': {'type': 'bool'},
                                                                                                                          'fragment_reassembly_exceeded': {'type': 'bool'},
                                                                                                                          'hop_limit_exceeded': {'type': 'bool'},
                                                                                                                          ...
                                                                                                                          'parameter_problem': {'type': 'bool'},
                                                                                                                          'port_unreachable': {'type': 'bool'},
                                                                                                                          'redirect_message': {'type': 'bool'},
                                                                                                                          'reject_route': {'type': 'bool'},
                                                                                                                          'router_advertisement': {'type': 'bool'},
                                                                                                                          'router_solicitation': {'type': 'bool'},
                                                                                                                          'source_address_failed': {'type': 'bool'},
                                                                                                                          'source_routing_error': {'type': 'bool'},
                                                                                                                          'time_exceeded': {'type': 'bool'},
                                                                                                                          'unreachable': {'type': 'bool'},
                                                                                                                          'unrecognized_ipv6_option': {'type': 'bool'},
                                                                                                                          'unrecognized_next_header': {'type': 'bool'}},
                                                                                                              'type': 'dict'},
                                                                                                   'ip': {'options': {'nexthop_group': {'type': 'str'}},
                                                                                                          'type': 'dict'},
                                                                                                   'ipv6': {'options': {'nexthop_group': {'type': 'str'}},
                                                                                                            'type': 'dict'},
